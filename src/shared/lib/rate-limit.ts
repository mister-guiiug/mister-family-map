 ...
 *
 * CE FICHIER ÉTAIT LA SOURCE DE `@mister-guiiug/dev-wpa-config/rate-limit`,
 ...
 */
export type { RateLimiter } from '@mister-guiiug/dev-wpa-config/rate-limit';
export { createRateLimiter } from '@mister-guiiug/dev-wpa-config/rate-limit';
