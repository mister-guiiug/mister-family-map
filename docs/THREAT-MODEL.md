...
| Menace           | Scénario                          | Mitigations                                                                                                                     | Reste à faire                                                                                                             |
| ---------------- | --------------------------------- | ------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------- |
| Info. disclosure | EXIF/GPS révèle domicile ou école | Ré-encodage canvas côté client (`stripImageMetadata` de `@mister-guiiug/dev-pwa-config/image`) : EXIF supprimé par construction | Câbler l'appel au téléversement — aucune photo n'est encore envoyée ; vérification serveur (re-encodage) en fonction Edge |
